...
namespace Zarat.HTTP
{
    ...
    public class HTTP : Model
    {
        ...
        public HTTP()
        {
            ...
            r.Add(new Routine((Type)null, "http.request", "Erzeugt ein neues HttpRequest-Objekt."));

            r.Add(new Routine((Type)null, "http.send", (Type)null, "Sendet ein HttpRequest und liefert ein HttpResponse zurück."));


            r.Add(new Routine((Type)null, "http.open_stream", (Type)null, "Öffnet HTTP Response als Stream und liefert HttpStream."));
            r.Add(new Routine((Type)null, "http.stream_read_bytes", (Type)null, (Type)null, "Liest bis zu N Bytes. (stream, maxBytes) -> byte[] (leer = Ende)."));
            r.Add(new Routine((Type)null, "http.stream_read_line", (Type)null, "Liest eine Textzeile (UTF-8). -> string oder null bei Ende."));
            r.Add(new Routine((Type)null, "http.stream_close", (Type)null, "Schließt HttpStream."));
